...
urlpatterns = [
    ...
    path('admin-dashboard/order/<int:order_id>/update/', views.update_order_status, name='update_order_status'),
    path('admin-dashboard/update-payment/<int:order_id>/', views.update_payment_status, name='update_payment_status'),
